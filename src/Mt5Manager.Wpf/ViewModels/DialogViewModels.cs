...
public sealed partial class CleanupViewModel:ObservableObject
{
    ...
    public IReadOnlyList<CleanupCategoryViewModel> Categories{get;} public bool CanPrepare=>terminal.DataDirectoryVerified&&Categories.Any(x=>x.IsSelected)&&IsDestructiveConfirmed&&!IsBusy;
